...
export default function Contact() {
    ...
    const socialLinks = [
        { href: 'https://www.linkedin.com/in/swapniltech/', Icon: LinkedInIcon, label: 'LinkedIn' },
        { href: 'https://github.com/swapnilgarg7', Icon: GithubIcon, label: 'Github' },
        { href: 'https://twitter.com/theswapnilgarg', Icon: TwitterIcon, label: 'Twitter' },
    ]
    ...
    return (
        <div id="contact" className="p-5 flex flex-col items-center mb-32" ref={contactRef}>
            ...
            <div className='sm:w-2/3 flex flex-col sm:flex-row justify-center items-center gap-12'>
                ...
                <div>
                    <div className="text-blue text-2xl font-semibold mb-8">Let's connect!</div>
                        ...
                        {socialLinks.map(({ href, Icon, label }) => (
                            <MagneticButton key={label} strength={0.3}>
                                <a href={href} target="_blank" rel="noreferrer" className="flex items-center gap-2">
                                    <Icon />
                                    <span className="text-white font-semibold text-lg hover:text-blue">{label}</span>
                                </a>
                            </MagneticButton>
                        ))}
                        <MagneticButton strength={0.3}>
                            <a href='https://www.youtube.com/@swapnil_tech' target="_blank" rel="noreferrer" className="flex items-center gap-2">
